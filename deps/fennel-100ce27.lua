package.preload["fennel.repl"] = package.preload["fennel.repl"] or function(...)
  ...
  local function default_on_error(errtype, err, lua_source)
    local function _607_()
      local _606_0 = errtype
      if (_606_0 == "Lua Compile") then
        return ("Bad code generated - likely a bug with the compiler:\n" .. "--- Generated Lua Start ---\n" .. lua_source .. "--- Generated Lua End ---\n")
      elseif (_606_0 == "Runtime") then
  ...
  local function splice_save_locals(env, lua_source, scope)
    ...
    do
      ...
      for name in pairs(env.___replLocals___) do
        local val_19_ = ("local %s = ___replLocals___['%s']"):format(name, name)
        if (nil ~= val_19_) then
          i_18_ = (i_18_ + 1)
    ...
    do
      ...
      for _, name in pairs(scope.manglings) do
        ...
        if not scope.gensyms[name] then
          val_19_ = ("___replLocals___['%s'] = %s"):format(name, name)
        else
        val_19_ = nil
        end
        if (nil ~= val_19_) then
    ...
    local function _616_()
      local _614_0, _615_0 = lua_source:match("^(.*)[\n ](return .*)$")
      if ((nil ~= _614_0) and (nil ~= _615_0)) then
        local body = _614_0
        local _return = _615_0
  ...
  local function completer(env, scope, text)
    ...
    local function add_partials(input, tbl, prefix)
      ...
      for k, is_mangled in utils.allpairs(_618_()) do
  ...
  local function reload(module_name, env, on_values, on_error)
    local _629_0, _630_0 = pcall(specials["load-code"]("return require(...)", env), module_name)
    if ((_629_0 == true) and (nil ~= _630_0)) then
      local old = _630_0
      local _ = nil
      ...
      return on_values({"ok"})
    elseif ((_629_0 == false) and (nil ~= _630_0)) then
      local msg = _630_0
      ...
      elseif specials["macro-loaded"][module_name] then
        ...
        local function _635_()
          local _634_0 = msg:gsub("\n.*", "")
          return _634_0
        end
        return on_error("Runtime", _635_())
      end
    end
  end
  local function run_command(read, on_error, f)
    local _638_0, _639_0, _640_0 = pcall(read)
    if ((_638_0 == true) and (_639_0 == true) and (nil ~= _640_0)) then
      local val = _640_0
      return f(val)
    elseif (_638_0 == false) then
  ...
  local function apropos_2a(pattern, tbl, prefix, seen, names)
    for name, subtbl in pairs(tbl) do
      if (("string" == type(name)) and (package ~= subtbl)) then
        local _644_0 = type(subtbl)
        if (_644_0 == "function") then
          if ((prefix .. name)):match(pattern) then
            table.insert(names, (prefix .. name))
          end
        elseif (_644_0 == "table") then
          if not seen[subtbl] then
            ...
            apropos_2a(pattern, subtbl, (prefix .. name:gsub("%.", "/") .. "."), _646_, names)
          end
        end
      end
    end
    ...
    for _, path in ipairs(apropos(".*")) do
      ...
      do
        ...
        if ("function" == type(tgt)) then
          local _655_0 = (compiler.metadata):get(tgt, "fnl/docstring")
          if (nil ~= _655_0) then
            local docstr = _655_0
  ...
  local function resolve(identifier, _662_0, scope)
    local _663_ = _662_0
    local env = _663_
    local ___replLocals___ = _663_["___replLocals___"]
    local e = nil
    local function _664_(_241, _242)
      return (___replLocals___[_242] or env[_242])
    end
    e = setmetatable({}, {__index = _664_})
    local _665_0, _666_0 = pcall(compiler["compile-string"], tostring(identifier), {scope = scope})
  ...
  local function repl(_3foptions)
    ...
    local function _697_(parser_state)
      local c = byte_stream(parser_state)
      table.insert(chars, c)
      return c
    end
    read, reset = parser.parser(_697_)
    ...
    if opts.registerCompleter then
      local function _700_()
        local _699_0 = opts.scope
        local function _701_(...)
          return completer(env, _699_0, ...)
        end
        return _701_
      end
      opts.registerCompleter(_700_())
    end
    ...
    local function loop()
      ...
      elseif command_3f(src_string) then
        ...
        if not_eof_3f then
          do
            local _705_0, _706_0 = nil, nil
            local function _707_()
              opts["source"] = src_string
              return opts
            end
            _705_0, _706_0 = pcall(compiler.compile, x, _707_())
            if ((_705_0 == false) and (nil ~= _706_0)) then
              local msg = _706_0
              clear_stream()
              on_error("Compile", msg)
            elseif ((_705_0 == true) and (nil ~= _706_0)) then
              local src = _706_0
              local src0 = nil
              if save_locals_3f then
              ...
              local _709_0, _710_0 = pcall(specials["load-code"], src0, env)
              if ((_709_0 == false) and (nil ~= _710_0)) then
                local msg = _710_0
                clear_stream()
                on_error("Lua Compile", msg, src0)
              elseif (true and (nil ~= _710_0)) then
                local _1 = _709_0
                local chunk = _710_0
...
package.preload["fennel.specials"] = package.preload["fennel.specials"] or function(...)
  ...
  local function compile_value(v)
    ...
    local chunk = {}
    local _445_ = compiler.compile1(v, scope, chunk, opts)
    local _446_ = _445_[1]
    local v0 = _446_[1]
    return v0
  end
  ...
  local function insert_arglist(meta, arg_list)
    ...
    table.insert(meta, ("{" .. table.concat(utils.map(arg_list, _448_), ", ") .. "}"))
    return meta
  end
  ...
  local function get_fn_name(ast, scope, fn_name, multi)
    if (fn_name and (fn_name[1] ~= "nil")) then
      local _451_
      if not multi then
        _451_ = compiler["declare-local"](fn_name, {}, scope, ast)
      else
        _451_ = compiler["symbol-to-expression"](fn_name, scope)[1]
      end
      return _451_, not multi, 3
    else
      return nil, true, 2
    end
  end
  local function compile_named_fn(ast, f_scope, f_chunk, parent, index, fn_name, local_3f, arg_name_list, f_metadata)
    ...
    local _454_
    if local_3f then
      _454_ = "local function %s(%s)"
    else
      _454_ = "%s = function(%s)"
    end
    compiler.emit(parent, string.format(_454_, fn_name, table.concat(arg_name_list, ", ")), ast)
  ...
  SPECIALS.fn = function(ast, scope, parent)
    local f_scope = nil
    do
      local _461_0 = compiler["make-scope"](scope)
      _461_0["vararg"] = false
      f_scope = _461_0
    end
    local f_chunk = {}
  ...
  SPECIALS.lua = function(ast, _, parent)
    ...
    local _466_
    do
      local _465_0 = utils["sym?"](ast[2])
      if (nil ~= _465_0) then
        _466_ = tostring(_465_0)
      else
        _466_ = _465_0
      end
    end
    ...
    local _470_
    do
      local _469_0 = utils["sym?"](ast[3])
      if (nil ~= _469_0) then
        _470_ = tostring(_469_0)
      else
        _470_ = _469_0
      end
    end
  ...
  local function dot(ast, scope, parent)
    ...
    local len = #ast
    local _473_ = compiler.compile1(ast[2], scope, parent, {nval = 1})
    local lhs = _473_[1]
    if (len == 2) then
      return tostring(lhs)
    else
      ...
      for i = 3, len do
        ...
        if (utils["string?"](index) and utils["valid-lua-identifier?"](index)) then
          ...
          local _474_ = compiler.compile1(index, scope, parent, {nval = 1})
          local index0 = _474_[1]
  ...
  local function disambiguate_3f(rootstr, parent)
    local function _483_()
      local _482_0 = get_prev_line(parent)
      if (nil ~= _482_0) then
        local prev_line = _482_0
  ...
  SPECIALS.tset = function(ast, scope, parent)
    ...
    local keys = {}
    for i = 3, (#ast - 1) do
      local _485_ = compiler.compile1(ast[i], scope, parent, {nval = 1})
      local key = _485_[1]
  ...
  local function compile_until(condition, scope, chunk)
    if condition then
      local _494_ = compiler.compile1(condition, scope, chunk, {nval = 1})
  ...
  local function method_call(ast, scope, parent)
    ...
    local _500_ = compiler.compile1(ast[2], scope, parent, {nval = 1})
    local target = _500_[1]
    local args = {}
    for i = 4, #ast do
      local subexprs = nil
      local _501_
  ...
  SPECIALS.hashfn = function(ast, scope, parent)
    ...
    local f_scope = nil
    do
      local _506_0 = compiler["make-scope"](scope)
      _506_0["vararg"] = false
      _506_0["hashfn"] = true
      f_scope = _506_0
    end
  ...
  local function native_comparator(op, _528_0, scope, parent)
    local _529_ = _528_0
    local _ = _529_[1]
    local lhs_ast = _529_[2]
    local rhs_ast = _529_[3]
    local _530_ = compiler.compile1(lhs_ast, scope, parent, {nval = 1})
    local lhs = _530_[1]
    local _531_ = compiler.compile1(rhs_ast, scope, parent, {nval = 1})
    local rhs = _531_[1]
  ...
  local function make_compiler_env(ast, scope, parent, _3fopts)
    local provided = nil
    do
      local _542_0 = (_3fopts or utils.root.options)
      if ((_G.type(_542_0) == "table") and (_542_0["compiler-env"] == "strict")) then
        provided = safe_compiler_env()
      elseif ((_G.type(_542_0) == "table") and (nil ~= _542_0.compilerEnv)) then
        local compilerEnv = _542_0.compilerEnv
        provided = compilerEnv
      elseif ((_G.type(_542_0) == "table") and (nil ~= _542_0["compiler-env"])) then
        local compiler_env = _542_0["compiler-env"]
    ...
    env = {["assert-compile"] = compiler.assert, ["ast-source"] = utils["ast-source"], ["comment?"] = utils["comment?"], ["get-scope"] = _544_, ["in-scope?"] = _545_, ["list?"] = utils["list?"], ["macro-loaded"] = macro_loaded, ["multi-sym?"] = utils["multi-sym?"], ["sequence?"] = utils["sequence?"], ["sym?"] = utils["sym?"], ["table?"] = utils["table?"], ["varg?"] = utils["varg?"], _AST = ast, _CHUNK = parent, _IS_COMPILER = true, _SCOPE = scope, _SPECIALS = compiler.scopes.global.specials, _VARARG = utils.varg(), comment = utils.comment, gensym = _546_, list = utils.list, macroexpand = _547_, metadata = compiler.metadata, sequence = utils.sequence, sym = utils.sym, unpack = unpack, version = utils.version, view = view}
    env._G = env
  ...
  local _550_ = _548_(...)
  local dirsep = _550_[1]
  local pathsep = _550_[2]
  local pathmark = _550_[3]
  ...
  local function search_module(modulename, _3fpathstring)
    ...
    local function try_path(path)
      ...
      local _551_0 = (io.open(filename) or io.open(filename2))
      if (nil ~= _551_0) then
        local file = _551_0
        file:close()
        return filename
    ...
    local function find_in_path(start, _3ftried_paths)
      local _553_0 = fullpath:match(pattern, start)
      if (nil ~= _553_0) then
        local path = _553_0
        local _554_0, _555_0 = try_path(path)
        if (nil ~= _554_0) then
          local filename = _554_0
          return filename
        elseif ((_554_0 == nil) and (nil ~= _555_0)) then
          local error = _555_0
          local function _557_()
            local _556_0 = (_3ftried_paths or {})
            table.insert(_556_0, error)
            return _556_0
          end
  ...
  local function make_searcher(_3foptions)
    local function _562_(module_name)
      ...
      local _563_0, _564_0 = search_module(module_name)
      if (nil ~= _563_0) then
  ...
  local function fennel_macro_searcher(module_name)
    local opts = nil
    do
      local _567_0 = utils.copy(utils.root.options)
      _567_0["module-name"] = module_name
      _567_0["env"] = "_COMPILER"
      _567_0["requireAsInclude"] = false
      _567_0["allowedGlobals"] = nil
      opts = _567_0
    end
    local _568_0 = search_module(module_name, utils["fennel-module"]["macro-path"])
    if (nil ~= _568_0) then
      local filename = _568_0
      local _569_
  ...
  local function lua_macro_searcher(module_name)
    local _574_0 = search_module(module_name, package.path)
    if (nil ~= _574_0) then
      local filename = _574_0
      local code = nil
      do
        ...
        code = close_handlers_10_(_G.xpcall(_576_, (package.loaded.fennel or debug).traceback))
      end
  ...
  local function search_macro_module(modname, n)
    local _578_0 = macro_searchers[n]
    if (nil ~= _578_0) then
      local f = _578_0
      local _579_0, _580_0 = f(modname)
      if ((nil ~= _579_0) and true) then
        local loader = _579_0
        local _3ffilename = _580_0
  ...
  local function _584_(modname)
    ...
    return (macro_loaded[modname] or sandbox_fennel_module(modname) or _585_())
  end
  safe_require = _584_
  ...
  local function resolve_module_name(_586_0, _scope, _parent, opts)
    local _587_ = _586_0
    local second = _587_[2]
    local filename = _587_["filename"]
...
if ("import-macros" == tostring(ast[1])) then
  ...
  local function include_path(ast, opts, path, mod, fennel_3f)
    ...
    do
      ...
      src = close_handlers_10_(_G.xpcall(_593_, (package.loaded.fennel or debug).traceback))
    end
  ...
  SPECIALS.include = function(ast, scope, parent, opts)
    ...
    local modexpr = nil
    do
      local _596_0, _597_0 = pcall(resolve_module_name, ast, scope, parent, opts)
      if ((_596_0 == true) and (nil ~= _597_0)) then
        local modname = _597_0
    ...
    if ((modexpr.type ~= "literal") or ((modexpr[1]):byte() ~= 34)) then
      ...
      local function _601_()
        local _600_0 = search_module(mod)
        if (nil ~= _600_0) then
          local fennel_path = _600_0
      ...
      res = ((utils["member?"](mod, (utils.root.options.skipInclude or {})) and opts.fallback(modexpr, true)) or include_circular_fallback(mod, modexpr, opts.fallback, ast) or utils.root.scope.includes[mod] or _601_())
...
package.preload["fennel.compiler"] = package.preload["fennel.compiler"] or function(...)
  ...
  local function assert_compile(condition, msg, ast, _3ffallback_ast)
    if not condition then
      local _269_ = (utils.root.options or {})
      local error_pinpoint = _269_["error-pinpoint"]
      local source = _269_["source"]
      local unfriendly = _269_["unfriendly"]
      local ast0 = nil
  ...
  local function serialize_string(str)
    ...
    return string.gsub(string.gsub(string.format("%q", str), ".", serialize_subst), "[\128-\255]", _274_)
  end
  local function global_mangling(str)
    if utils["valid-lua-identifier?"](str) then
      ...
      return ("__fnl_global__" .. str:gsub("[^%w]", _275_))
    end
  end
  local function global_unmangling(identifier)
    local _277_0 = string.match(identifier, "^__fnl_global__(.*)$")
    if (nil ~= _277_0) then
      local rest = _277_0
      local _278_0 = nil
      ...
      _278_0 = string.gsub(rest, "_[%da-f][%da-f]", _279_)
      return _278_0
    else
      local _ = _277_0
      return identifier
  ...
  local function local_mangling(str, scope, ast, _3ftemp_manglings)
    ...
    mangling = string.gsub(string.gsub(raw, "-", "_"), "[^%w_]", _283_)
  ...
  local function make_metadata()
    local function _310_(self, tgt, key)
      if self[tgt] then
        return self[tgt][key]
      end
    end
    ...
    return setmetatable({}, {__index = {get = _310_, set = _312_, setall = _313_}, __mode = "k"})
  end
  ...
  local function destructure(to, from, ast, scope, parent, opts)
    ...
    local function destructure_kv_rest(s, v, left, excluded_keys, destructure1)
      ...
      exclude_str = table.concat(_377_, ", ")
    ...
    local function destructure_table(left, rightexprs, top_3f, destructure1)
      ...
      do
        local _379_0 = nil
        if top_3f then
          _379_0 = exprs1(compile1(from, scope, parent))
        else
          _379_0 = exprs1(rightexprs)
        end
        if (_379_0 == "") then
          right = "nil"
        elseif (nil ~= _379_0) then
          local right0 = _379_0
          right = right0
        else
        right = nil
  ...
  local function traceback_frame(info)
    ...
    elseif (info.what == "C") then
      ...
      if (info.what == "Lua") then
        ...
        return string.format("  %s:%d: in function %s", info.short_src, info.currentline, _401_())
...
package.preload["fennel.friend"] = package.preload["fennel.friend"] or function(...)
  ...
  local function assert_compile(condition, msg, ast, source, opts)
    if not condition then
      local _195_ = utils["ast-source"](ast)
      local col = _195_["col"]
...
package.preload["fennel.parser"] = package.preload["fennel.parser"] or function(...)
    ...
    local function _197_(parser_state)
      if not done_3f then
        if (index <= #c) then
          ...
          local _198_0 = getchunk(parser_state)
          local function _199_()
            local char = _198_0
            return (char ~= "")
          end
          if ((nil ~= _198_0) and _199_()) then
            local char = _198_0
            c = char
            index = 2
            return c:byte()
  ...
  local function char_starter_3f(b)
    return ((function(_207_,_208_,_209_) return (_207_ < _208_) and (_208_ < _209_) end)(1,b,127) or (function(_210_,_211_,_212_) return (_210_ < _211_) and (_211_ < _212_) end)(192,b,247))
  end
  local function parser_fn(getbyte, filename, _213_0)
    local _214_ = _213_0
    local options = _214_
    local comments = _214_["comments"]
    local source = _214_["source"]
    local unfriendly = _214_["unfriendly"]
    local stack = {}
    ...
    local function whitespace_3f(b)
      ...
      return ((b == 32) or (function(_220_,_221_,_222_) return (_220_ <= _221_) and (_221_ <= _222_) end)(9,b,13) or _224_())
    end
    ...
    local function parse_stream()
      ...
      local function dispatch(v)
        local _228_0 = stack[#stack]
        if (_228_0 == nil) then
          retval, done_3f, whitespace_since_dispatch = v, true, false
          return nil
        elseif ((_G.type(_228_0) == "table") and (nil ~= _228_0.prefix)) then
          local prefix = _228_0.prefix
          local source0 = nil
          do
            local _229_0 = table.remove(stack)
            set_source_fields(_229_0)
            source0 = _229_0
          end
      ...
      local function badend()
        ...
        return parse_error(string.format("expected closing delimiter%s %s", _231_, string.char(unpack(accum))))
      end
      ...
      local function parse_comment(b, contents)
        if (b and (10 ~= b)) then
          ...
          return parse_comment(getb(), _234_())
      ...
      local function add_comment_at(comments0, index, node)
        local _237_0 = comments0[index]
        if (nil ~= _237_0) then
          local existing = _237_0
      ...
      local function parse_string_loop(chars, b, state)
        ...
        local state0 = nil
        do
          local _247_0 = {state, b}
          if ((_G.type(_247_0) == "table") and (_247_0[1] == "base") and (_247_0[2] == 92)) then
            state0 = "backslash"
          elseif ((_G.type(_247_0) == "table") and (_247_0[1] == "base") and (_247_0[2] == 34)) then
            state0 = "done"
          elseif ((_G.type(_247_0) == "table") and (_247_0[1] == "backslash") and (_247_0[2] == 10)) then
      ...
      local function parse_string()
        ...
        local _251_0 = (rawget(_G, "loadstring") or load)(("return " .. formatted))
        if (nil ~= _251_0) then
          local load_fn = _251_0
          return dispatch(load_fn())
        elseif (_251_0 == nil) then
      ...
      local function parse_number(rawstr)
        ...
        if rawstr:match("^%d") then
          ...
          local _257_0 = tonumber(number_with_stripped_underscores)
          if (nil ~= _257_0) then
            local x = _257_0
            dispatch(x)
            return true
...
package.preload["fennel.view"] = package.preload["fennel.view"] or function(...)
  ...
  local function detect_cycle(t, seen, _3fk)
    if ("table" == type(t)) then
      seen[t] = true
      local _36_0, _37_0 = next(t, _3fk)
      if ((nil ~= _36_0) and (nil ~= _37_0)) then
        local k = _36_0
        local v = _37_0
  ...
  local function pp_metamethod(t, metamethod, options, indent)
    if (options.depth <= options.level) then
      ...
      local _65_0 = type(lines)
      if (_65_0 == "string") then
        return lines
      elseif (_65_0 == "table") then
  ...
  local function pp_table(x, options, indent)
    ...
    do
      ...
      if getopt(options, "metamethod?") then
        local _69_0 = x
        if (nil ~= _69_0) then
          local _70_0 = getmetatable(_69_0)
          if (nil ~= _70_0) then
            _68_0 = _70_0.__fennelview
          else
            _68_0 = _70_0
          end
        else
      ...
      if (nil ~= _68_0) then
        local metamethod = _68_0
        x0 = pp_metamethod(x, metamethod, options, indent)
      else
        local _ = _68_0
        local _74_0, _75_0 = table_kv_pairs(x, options)
        if (true and (_75_0 == "empty")) then
          local _0 = _74_0
          if getopt(options, "empty-as-sequence?") then
            x0 = "[]"
          else
        ...
        elseif ((nil ~= _74_0) and (_75_0 == "table")) then
          local kv = _74_0
          x0 = pp_associative(x, kv, options, indent)
        elseif ((nil ~= _74_0) and (_75_0 == "seq")) then
          local kv = _74_0
  ...
  local function number__3estring(n)
    local _79_0 = string.gsub(tostring(n), ",", ".")
    return _79_0
  end
  ...
  local function _102_(x, options, indent, colon_3f)
    ...
    local function _105_()
      local _104_0 = getmetatable(x0)
      if (nil ~= _104_0) then
        return _104_0.__fennelview
      else
        return _104_0
      end
    end
...
package.preload["fennel.utils"] = package.preload["fennel.utils"] or function(...)
  ...
  local len = nil
  do
    local _112_0, _113_0 = pcall(require, "utf8")
    if ((_112_0 == true) and (nil ~= _113_0)) then
      local utf8 = _113_0
      len = utf8.len
    else
      local _ = _112_0
  ...
  local function kvmap(t, f, _3fout)
    ...
    for k, x in stablepairs(t) do
      local _137_0, _138_0 = f0(k, x)
      if ((nil ~= _137_0) and (nil ~= _138_0)) then
        local key = _137_0
        local value = _138_0
        out[key] = value
      elseif (nil ~= _137_0) then
        local value = _137_0
  ...
  local function member_3f(x, tbl, _3fn)
    local _141_0 = tbl[(_3fn or 1)]
    if (_141_0 == x) then
      return true
    elseif (_141_0 == nil) then
      return nil
    else
      local _ = _141_0
  ...
  local function allpairs(tbl)
    ...
    local function allpairs_next(_, state)
      ...
      elseif next_state then
        ...
        local _144_0 = getmetatable(t)
        if ((_G.type(_144_0) == "table") and true) then
          local __index = _144_0.__index
          if ("table" == type(__index)) then
            t = __index
  ...
  local function sequence(...)
    ...
    return setmetatable({...}, {__fennelview = _155_, sequence = sequence_marker})
  end
  local function expr(strcode, etype)
    return setmetatable({strcode, type = etype}, expr_mt)
  end
  local function comment_2a(contents, _3fsource)
    local _156_ = (_3fsource or {})
    local filename = _156_["filename"]
    local line = _156_["line"]
  ...
  local function varg(_3fsource)
    ...
    return setmetatable(_157_, varg_mt)
  end
...
local function eval(str, options, ...)
  ...
  loader = specials["load-code"](lua_source, env, _723_(...))
  opts.filename = nil
  return loader(...)
end
...
local function syntax()
  ...
  for k, v in pairs(_G) do
    local _724_0 = type(v)
    if (_724_0 == "function") then
      out[k] = {["function?"] = true, ["global?"] = true}
    elseif (_724_0 == "table") then
...
do
  ...
  package.preload[module_name] = _727_
  _ = nil
  local env = nil
  do
    local _728_0 = specials["make-compiler-env"](nil, compiler.scopes.compiler, {})
    _728_0["utils"] = utils
    _728_0["fennel"] = mod
    env = _728_0
  end
