 ...
 local ftplugin = require("hotpot.neovim.ftplugin") do

 ftplugin.enable() end
 if config.provide_require_fennel then
 local function _18_() return require("hotpot.fennel") end package.preload["fennel"] = _18_ else end
 if config.enable_hotpot_diagnostics then
 local _let_20_ = require("hotpot.api.diagnostics") local enable = _let_20_["enable"]
